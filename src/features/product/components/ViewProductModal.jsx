        ...
        >
            <div className="flex flex-col h-full text-text-primary">
                <div className="space-y-2 flex-grow bg-background-100 p-2 rounded">
                    ...
                    <p><span className="font-semibold">Nombre:</span> {product.name || "SIN NOMBRE"}</p>
                    ...
                    <p><span className="font-semibold">Eliminado en:</span> {product.deleted_at || "N/A"}</p>
                    ...
                    <p><span className="font-semibold">Eliminado por:</span> {product.deleted_by || "N/A"}</p>
                </div>
